...
#ifndef MODULEDESPECKLE_H
#define MODULEDESPECKLE_H
...
class EffectModuleDespeckle : public QObject, public EffectBase
{
	Q_OBJECT
public:
	EffectModuleDespeckle(QObject * parent = NULL);
	~EffectModuleDespeckle() override;
	
	bool available() override;
	QString getName() override  {return QString(tr("Despeckle"));};
