...
class EffectModuleSwapChannels : public QObject, public EffectBase
{
	Q_OBJECT
public:
	EffectModuleSwapChannels(QObject * parent = NULL);
	~EffectModuleSwapChannels() override;
	
	bool available() override  {return true;};
	QString getName() override  {return QString(tr("Swap channels"));};
