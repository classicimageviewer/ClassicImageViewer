...
class EffectModuleUnsharp : public QObject, public EffectBase
{
	Q_OBJECT
public:
	EffectModuleUnsharp(QObject * parent = NULL);
	~EffectModuleUnsharp() override;
	
	bool available() override  {return true;};
	QString getName() override  {return QString(tr("Unsharp"));};
